...
public interface AccountService extends FindByPageService<AccountDto> {
    ...
    ResultData<AccountDto> getById(String id);
    ...
    @ApiOperation("创建新账户")
    ResultData<String> create(AccountDto dto);
    ...
    @ApiOperation("更新账户")
    ResultData<String> udapte(AccountDto dto);
    ...
    @ApiOperation("更新密码")
    ResultData<String> updatePassword(AccountDto dto);
    ...
    @ApiOperation("重置密码")
    ResultData<String> resetPassword(AccountDto dto);
}
