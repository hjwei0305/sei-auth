...
/**
 * 实现功能：邮箱认证TokenGranter
 * 邮箱接收验证码认证登录
 *
 * @author 马超(Vision.Mac)
 * @version 1.0.00  2020-01-20 12:57
 */
@Component(TokenAuthenticator.AUTH_TYPE_EMAIL)
public class EmailTokenAuthenticator extends AbstractTokenAuthenticator implements TokenAuthenticator {
